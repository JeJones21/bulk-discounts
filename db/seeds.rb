...
item_6 = Item.create!(name: 'lederhosen', description: 'pants', unit_price: 99, merchant_id: m2.id)
item_7 = Item.create!(name: 'buttless chaps', description: 'pants', unit_price: 50, merchant_id: m3.id)
item_8 = Item.create!(name: 'starter jacket', description: 'coat', unit_price: 75, merchant_id: m4.id)
