...
RSpec.describe Invoice, type: :model do
  ...
  describe "instance methods" do
    ...
    it "totals the revenue" do
      expect(@invoice_1.total_rev).to eq(100)
    end
  end

  describe 'example 1 of discounted revenue' do
    before :each do
      @merchant1 = Merchant.create!(name: 'Hair Care')
      @item_1 = Item.create!(name: "Shampoo", description: "This washes your hair", unit_price: 10, merchant_id: @merchant1.id, status: 1)
      @item_8 = Item.create!(name: "Butterfly Clip", description: "This holds up your hair but in a clip", unit_price: 5, merchant_id: @merchant1.id)
    ...
    it "does not qualify" do
      expect(@invoice_1.disc_total).to eq(100)
    end
  end

  describe 'example 2 of discounted revenue' do
    before :each do
      @merchant1 = Merchant.create!(name: 'Hair Care')
      @item_1 = Item.create!(name: "Shampoo", description: "This washes your hair", unit_price: 10, merchant_id: @merchant1.id, status: 1)
      @item_8 = Item.create!(name: "Butterfly Clip", description: "This holds up your hair but in a clip", unit_price: 5, merchant_id: @merchant1.id)
    ...
    it "it can determine if you are worthy of a discount based on quantity" do

      expect(@invoice_1.disc_total).to eq(130)
    end
  end
end
